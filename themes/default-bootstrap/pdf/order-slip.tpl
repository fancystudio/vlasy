...
<!--  číslo faktury -->
		...
		{l s='Order slip no.' pdf='true'} &nbsp; {$order_slip_prefix}{'%06d'|sprintf:$order_slip->id}</td>
	</tr>
<!-- konec číslo faktury -->
	...
	<tr>
		...
		<table>
			...
			<tr style=" text-align:left">
				...
				<td>{dateFormat date=$order_slip->date_add full=0}</td>
			</tr>
			<tr style=" text-align:left">
		   		<td>{if $sk}
						{if $dic !=''}
				...
				<td>{if !$tax_excluded_display}{dateFormat date=$order_slip->date_add full=0}{/if}</td>
			</tr>
			{*<tr style=" text-align:left">
		   		<td></td>
	  ...
	  <td colspan="2" align="right" style="border-right:0px solid #000; weight:50%;">
	   	<table cellpadding="2" style="line-height:3px; text-align: right; font-weight:bold; font-size:7pt;">
			...
			{if $order_slip->shipping_cost_amount}
				<tr style="">
					<td style="">{l s='Shipping' pdf='true'}</td>
			...
			{if $order->total_discount_tax_incl > 0}
				<tr style="">
					<td style="">{l s='Total Vouchers' pdf='true'}</td>
					<td style="">- {displayPrice currency=$order->id_currency price=$order->total_discount_tax_incl}</td>
				</tr>
			{/if}

			{if $order->total_wrapping_tax_incl > 0}
				<tr style="">
					<td style="">{l s='Wrapping Cost' pdf='true'}</td>
					<td style="">
						{if $tax_excluded_display}
			...
			{if ($order->total_paid_tax_incl - $order->total_paid_tax_excl) > 0}
				<tr style="">
					<td style="">{l s='Total Tax' pdf='true'}</td>
			...
			<tr style="background-color: #EEE; font-size:10pt; line-height:5px;">
				<td style="width:22%; border-top:0px solid #000; border-left:0px solid #000; border-bottom:0px solid #000;">
					{l s='Total' pdf='true'}
				</td>
				<td style="width:18%; border-top:0px solid #000; border-right:0px solid #000; border-bottom:0px solid #000;">
