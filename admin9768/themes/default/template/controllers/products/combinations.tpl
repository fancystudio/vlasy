...
<div id="product-combinations" class="panel product-tab">
	...
	<div class="alert alert-info">
		<a class='btn btn-link bt-icon confirm_leave' href='index.php?tab=AdminAttributeGenerator&amp;id_product={$product->id}&amp;attributegenerator&amp;token={$token_generator}'>generator</a>
	</div>
