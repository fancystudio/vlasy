								...
								{elseif $input.type == 'switch'}
									<div "col-lg-9">
										<span class="switch prestashop-switch fixed-width-lg">
											...
											>
												{if $value.value == 1}
													{l s='Yes' mod='prestacenterxmlexportpro'}
												{else}
													{l s='No' mod='prestacenterxmlexportpro'}
												{/if}
											</label>
											{/foreach}
								...
								{elseif $input.type == 'change-password'}
									<div class="row">
										<div class="col-lg-12">
											<button type="button" id="{$input.name|strval}-btn-change" class="btn btn-default">
												<i class="icon-lock"></i>
												{l s='Change password...' mod='prestacenterxmlexportpro'}
											</button>
											<div id="{$input.name|strval}-change-container" class="form-password-change well hide">
												<div class="form-group ">
													<label for="old_passwd" class="control-label col-lg-2 required">
														{l s='Current password' mod='prestacenterxmlexportpro'}
													</label>
													<div class="col-lg-10">
												...
												<div class="form-group">
													<label for="{$input.name|strval}" class="required control-label col-lg-2">
														<span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="Minimum of 8 characters.">
															{l s='New password' mod='prestacenterxmlexportpro'}
														</span>
													</label>
													<div class="col-lg-9">
														<div class="input-group fixed-width-lg">
												...
												<div class="form-group">
													<label for="{$input.name|strval}2" class="required control-label col-lg-2">
														{l s='Confirm password' mod='prestacenterxmlexportpro'}
													</label>
													<div class="col-lg-4">
														<div class="input-group fixed-width-lg">
															<span class="input-group-addon">
												...
												<div class="form-group">
													<div class="col-lg-10 col-lg-offset-2">
														...
														<button type="button" id="{$input.name|strval}-generate-btn" class="btn btn-default">
															...
															{l s='Generate password' mod='prestacenterxmlexportpro'}
														</button>
													</div>
												</div>
												<div class="form-group">
													<div class="col-lg-10 col-lg-offset-2">
														<p class="checkbox">
															<label for="{$input.name|strval}-checkbox-mail">
																...
																{l s='Send me this new password by Email' mod='prestacenterxmlexportpro'}
															</label>
														</p>
													</div>
												</div>
												<div class="row">
													<div class="col-lg-12">
														<button type="button" id="{$input.name|strval}-cancel-btn" class="btn btn-default">
															...
															{l s='Cancel' mod='prestacenterxmlexportpro'}
														</button>
													</div>
												</div>
											</div>
									...
									<script>
										$(function(){
											...
											var feedback = [
												{ badge: 'text-danger', text: '{l s="Invalid" js=1 mod='prestacenterxmlexportpro'}' },
												{ badge: 'text-warning', text: '{l s="Okay" js=1 mod='prestacenterxmlexportpro'}' },
												{ badge: 'text-success', text: '{l s="Good" js=1 mod='prestacenterxmlexportpro'}' },
												{ badge: 'text-success', text: '{l s="Fabulous" js=1 mod='prestacenterxmlexportpro'}' }
											];
											...
											}, '{l s="Invalid password confirmation" js=1 mod='prestacenterxmlexportpro'}');
										...
										<select name="{$key}" class="{if isset($input.class)}{$input.class}{/if}" class="fixed-width-lg">
											...
											{if $key == 'months'}
												{*
													...
													{l s='January' mod='prestacenterxmlexportpro'}
													{l s='February' mod='prestacenterxmlexportpro'}
													{l s='March' mod='prestacenterxmlexportpro'}
													{l s='April' mod='prestacenterxmlexportpro'}
													{l s='May' mod='prestacenterxmlexportpro'}
													{l s='June' mod='prestacenterxmlexportpro'}
													{l s='July' mod='prestacenterxmlexportpro'}
													{l s='August' mod='prestacenterxmlexportpro'}
													{l s='September' mod='prestacenterxmlexportpro'}
													{l s='October' mod='prestacenterxmlexportpro'}
													{l s='November' mod='prestacenterxmlexportpro'}
													{l s='December' mod='prestacenterxmlexportpro'}
												*}
												{foreach $select as $k => $v}
													<option value="{$k}" {if $k == $fields_value[$key]}selected="selected"{/if}>{l s=$v mod='prestacenterxmlexportpro'}</option>
												{/foreach}
											{else}
												{foreach $select as $v}
				...
				{if isset($fieldset['form']['submit']) || isset($fieldset['form']['buttons'])}
					<div class="panel-footer">
						...
						>
							...
							{else}{l s='Cancel' mod='prestacenterxmlexportpro'}
							{/if}
						</a>
						{/if}
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('.datetimepicker').datetimepicker({
				...
				currentText: '{l s='Now' mod='prestacenterxmlexportpro'}',
				closeText: '{l s='Done' mod='prestacenterxmlexportpro'}',
				ampm: false,
				amNames: ['AM', 'A'],
				pmNames: ['PM', 'P'],
				timeFormat: 'hh:mm:ss tt',
				timeSuffix: '',
				timeOnlyTitle: '{l s='Choose Time' mod='prestacenterxmlexportpro'}',
				timeText: '{l s='Time' mod='prestacenterxmlexportpro'}',
				hourText: '{l s='Hour' mod='prestacenterxmlexportpro'}',
				minuteText: '{l s='Minute' mod='prestacenterxmlexportpro'}',
			});
